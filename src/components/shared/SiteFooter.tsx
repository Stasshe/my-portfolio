...
export function SiteFooter() {
  ...
  return (
    <footer className="bg-dark py-[var(--space-xl)] pb-[var(--space-md)] text-white/85" id="contact">
      <div className={containerClass}>
        <div className="mb-[var(--space-xl)] flex flex-wrap items-start justify-between gap-[var(--space-lg)]">
          <div className="max-w-[640px]">
            <h2 id="footer-cta-title" className={`${headingLgClass} mb-[var(--space-md)] text-white`}>
              現場に向き合い、
              <span className="font-accent font-normal italic text-brand">使われ続ける</span>ものを。
            </h2>
